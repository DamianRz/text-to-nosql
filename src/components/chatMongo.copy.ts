...
export const copyByLanguage: Record<Language, CopyDictionary> = {
  es: {
    ...
    hostedBody:
      "La version online muestra la idea principal: escribes una instruccion en lenguaje natural y ves la consulta MongoDB que sale de ahi.",
    ...
    hostedWorkspaceNotice:
      "Si quieres probar generacion real, ejecucion y base simulada, ejecuta el proyecto en local desde el README.",
    ...
    demoDescription:
      "Elige un ejemplo y compara la instruccion, la query y el resultado esperado.",
    ...
    quickStartBody: "Escribe lo que necesitas. La consulta aparece primero y luego decides si quieres ejecutarla.",
    quickStartSteps: [
    ...
    quickStartTip: "Para probar rapido, empieza con un ejemplo y ajustalo desde el editor.",
    ...
    selectedDemoHelper: "Cada ejemplo actualiza la vista completa sin sacarte de la pantalla principal.",
  ...
  en: {
    ...
    hostedBody:
      "The hosted version keeps the idea simple: you write a request in natural language and inspect the MongoDB query it turns into.",
    ...
    hostedWorkspaceNotice: "For real generation, execution, and the simulated database, run the project locally from the README.",
    ...
    demoDescription:
      "Choose a demo and compare the prompt, the Mongo query, and the expected output.",
    ...
    quickStartBody: "Start with a short request. The query shows up first, then you decide whether to run it.",
    quickStartSteps: [
    ...
    quickStartTip: "Fastest path: pick an example first, then refine it in the editor.",
    ...
    selectedDemoHelper: "Each example updates the whole preview without taking you out of the main screen.",
